    ...
    public void inserir(Produto produto){
        ...
        try{
          ...
          JOptionPane.showMessageDialog(frame,
        	        "Produto " + produto.getDescricao_produto() + " gravado com sucesso!",
        	        "Sucesso",
     ...
     public void alterar(Produto produto){
        ...
        try{
          ...
          JOptionPane.showMessageDialog(frame,
      	        "Produto " + produto.getDescricao_produto() + " atualizado com sucesso!",
      	        "Sucesso",
      	        JOptionPane.INFORMATION_MESSAGE);
      ...
      public void excluir(Produto produto){
        String sql = "DELETE FROM produto WHERE codigo_produto = "+produto.getCodigo_produto();
        try{
          ...
          JOptionPane.showMessageDialog(frame,
        	        "Produto " + produto.getDescricao_produto() + " excluido com sucesso!",
        	        "Sucesso",
        	        JOptionPane.INFORMATION_MESSAGE);
